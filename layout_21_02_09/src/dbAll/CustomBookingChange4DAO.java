...
public class CustomBookingChange4DAO extends DBConn{

	public CustomBookingChange4DAO() {
		
	}
	public int newBookingDate(CustomBookingChange4VO vo) {
		int result = 0;
		try {
			getConn();
	...
	public List<CustomBookingChange4VO> getTable1(String newFlight, String resNo){
		List<CustomBookingChange4VO> lst = new ArrayList<CustomBookingChange4VO>();
		try {
			getConn();
	...
	public List<CustomBookingChange4VO> getTable2(String resNo){
		List<CustomBookingChange4VO> lst = new ArrayList<CustomBookingChange4VO>();
		try {
			getConn();
